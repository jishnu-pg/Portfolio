    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                .map((blog, index) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <button className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors flex items-center gap-2">
                        Read More
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-500 dark:to-purple-500 rounded-xl p-8 text-center text-white"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-400"
            />
            <button className="bg-white text-blue-600 dark:text-blue-500 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-200 transition-colors">
              Subscribe
            </button>
          </div>
        </motion.div>
